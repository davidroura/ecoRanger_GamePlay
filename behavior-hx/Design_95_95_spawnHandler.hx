	...
	override public function init()
	{
		...
		addWhenUpdatedListener(null, function(elapsedTime:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				/* Ocasional Spawn */
				if(((Engine.engine.getGameAttribute("playerHealth") > 1) && ((Engine.engine.getGameAttribute("playerDistance") % 110) == 0)))
				{
					_customEvent_ObstacleRamdomSpaw();
					_customEvent_addSpawn();
					_currentSpawnByDistance = asNumber((_currentSpawn * Engine.engine.getGameAttribute("playerDistance")));
					propertyChanged("_currentSpawnByDistance", _currentSpawnByDistance);
				}
				if(((Engine.engine.getGameAttribute("playerHealth") > 1) && ((Engine.engine.getGameAttribute("playerDistance") % 70) == 0)))
				{
				...
				if(((Engine.engine.getGameAttribute("playerHealth") > 1) && ((Engine.engine.getGameAttribute("playerDistance") % 50) == 0)))
				{

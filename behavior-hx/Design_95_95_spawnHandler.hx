...
class Design_95_95_spawnHandler extends SceneScript
{
	...
	public function _customEvent_selectObstacle():Void
	{
		...
		{
			if(((Engine.engine.getGameAttribute("ramdomUniversalNumber") * 120) < 40))
			{
				_customEvent_ObstacleRock();
			}
			else if(((Engine.engine.getGameAttribute("ramdomUniversalNumber") * 120) < 80))
			{
			...
			_customEvent_nextObstacleDistance();
	...
	/* ========================= Custom Event ========================= */
	public function _customEvent_nextObstacleDistance():Void
	{
		if((Engine.engine.getGameAttribute("playerDistance") < 400))
		{
			_a = asNumber(160);
			propertyChanged("_a", _a);
		}
		else if((Engine.engine.getGameAttribute("playerDistance") < 800))
		{
			_a = asNumber(120);
			propertyChanged("_a", _a);
		}
		else if((Engine.engine.getGameAttribute("playerDistance") < 1500))
		{
			_a = asNumber(80);
			propertyChanged("_a", _a);
		}
		else if((Engine.engine.getGameAttribute("playerDistance") < 230))
		{
			_a = asNumber(60);
			propertyChanged("_a", _a);
		}
		...
		_nextDistance = asNumber((Math.round((Engine.engine.getGameAttribute("ramdomUniversalNumber") * 20)) + _a));

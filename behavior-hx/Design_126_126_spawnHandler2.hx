...
class Design_126_126_spawnHandler2 extends SceneScript
{
	
	/* ========================= Custom Event ========================= */
	public function _customEvent_spawnLife():Void
	{
		createRecycledActorOnLayer(getActorType(10), (Math.round((Engine.engine.getGameAttribute("ramdomUniversalNumber") * 230)) + 50), -5, 1, "" + "gamePlay");
	}

	...
	override public function init()
	{
		...
		addWhenDrawingListener(null, function(g:G, x:Float, y:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				g.drawString("" + Engine.engine.getGameAttribute("total_cans"), 50, 15);
				g.drawString("" + Engine.engine.getGameAttribute("total_plasticBottles"), 110, 15);
				g.drawString("" + Engine.engine.getGameAttribute("total_glassBottles"), 170, 15);
				g.drawString("" + Engine.engine.getGameAttribute("recycling_cans"), 170, 60);
				g.drawString("" + Engine.engine.getGameAttribute("recycling_plasticBottle"), 110, 60);
				g.drawString("" + Engine.engine.getGameAttribute("recycling_glassBottles"), 50, 60);
			}
		});

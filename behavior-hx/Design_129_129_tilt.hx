...
class Design_129_129_tilt extends ActorScript
{
	...
	{
		if(((_boundaryRight > actor.getX()) && (actor.getX() > (_boundaryLeft - 1))))
		{
			actor.setX((actor.getX() - 1));
		}
		Engine.engine.setGameAttribute("lateralSpeed", 0);
	...
	override public function init()
	{
		...
		/* ======================== When Creating ========================= */
		_boundaryLeft = asNumber(0);
		propertyChanged("_boundaryLeft", _boundaryLeft);
		_boundaryRight = asNumber(320);

	...
	public function _customEvent_play():Void
	{
		...
		if(Engine.engine.getGameAttribute("tutorialDone"))
		{
			if((Engine.engine.getGameAttribute("playerHealth") > 0))
			{
				...
				{
					Engine.engine.setGameAttribute("sceneSpeed", 65);
				}
				else
				{
					/* banana boost */
					...
					{
						Engine.engine.setGameAttribute("sceneSpeed", Engine.engine.getGameAttribute("playerHealth"));
					}
				}

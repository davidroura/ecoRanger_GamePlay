	...
	override public function init()
	{
		...
		addWhenDrawingListener(null, function(g:G, x:Float, y:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				{
					g.fillColor = Utils.getColorRGB(0,204,51);
					_warning = false;
					propertyChanged("_warning", _warning);
				}
				...
				g.setFont(getFont(19));
				g.drawString("" + Engine.engine.getGameAttribute("canCollected"), 190, 447);
				g.drawString("" + Engine.engine.getGameAttribute("bottleColleted"), 250, 447);

...
class Design_37_37_autoKill extends ActorScript
{
	public var _timeCounter:Float;
	public var _framePerSeconds:Float;
	public var _time:Float;
	public var _killAtSec:Float;
	...
	override public function init()
	{
		...
		addWhenUpdatedListener(null, function(elapsedTime:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				propertyChanged("_timeCounter", _timeCounter);
				if((_timeCounter == _framePerSeconds))
				{

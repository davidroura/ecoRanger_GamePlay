...
class ActorEvents_180 extends ActorScript
{
	...
	{
		/* check if it's in the unlocked bot list */
		if(!(Utils.contains(Engine.engine.getGameAttribute("unlockedBotList"), StringTools.replace(("" + getLastCreatedActor().getAnimation()), ("" + "Off"), ("" + "")))))
		{
			trace("" + StringTools.replace(("" + getLastCreatedActor().getAnimation()), ("" + "Off"), ("" + "")));
			trace("" + "turns to QuestionMark");
		...
		if(Utils.contains(Engine.engine.getGameAttribute("selectedBotList"), StringTools.replace(("" + getLastCreatedActor().getAnimation()), ("" + "Off"), ("" + ""))))
		{
			...
			trace("" + (("" + "found and turns to ") + ("" + StringTools.replace(("" + getLastCreatedActor().getAnimation()), ("" + "Off"), ("" + "On")))));
			/* this event happens in the actual icon actor */

...
class SceneEvents_0 extends SceneScript
{
	...
	override public function init()
	{
		...
		createRecycledActor(getActorType(248), 0, 210, Script.FRONT);
		createRecycledActor(getActorType(248), 0, 290, Script.FRONT);
		...
		addWhenDrawingListener(null, function(g:G, x:Float, y:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				g.drawString("" + Engine.engine.getGameAttribute("collected_PlasticBottles"), (150 - getFont(136).font.getTextWidth(Engine.engine.getGameAttribute("collected_PlasticBottles"))/Engine.SCALE), 2);
				...
				if(Engine.engine.getGameAttribute("gameOver"))
				{
					...
					{
						g.drawString("" + _tempNumber, (161 - getFont(136).font.getTextWidth(("" + _tempNumber))/Engine.SCALE), 250);
					}
					else
					{
						g.drawString("" + Engine.engine.getGameAttribute("collected_PlasticBottles"), (161 - getFont(136).font.getTextWidth(Engine.engine.getGameAttribute("collected_PlasticBottles"))/Engine.SCALE), 250);
					}
					if((_tempNumber < Engine.engine.getGameAttribute("collected_glassBottle")))
					{
						g.drawString("" + _tempNumber, (250 - getFont(136).font.getTextWidth(("" + _tempNumber))/Engine.SCALE), 250);
					}
					else
					{
						g.drawString("" + Engine.engine.getGameAttribute("collected_glassBottle"), (250 - getFont(136).font.getTextWidth(Engine.engine.getGameAttribute("collected_glassBottle"))/Engine.SCALE), 250);
					}
					g.setFont(getFont(274));
					if((_tempDistanceNum < Engine.engine.getGameAttribute("playerDistance")))
					{
						g.drawString("" + (("" + _tempDistanceNum) + ("" + " METERS")), ((320 - getFont(274).font.getTextWidth((("" + Engine.engine.getGameAttribute("playerDistance")) + ("" + " METERS")))/Engine.SCALE) / 2), 120);
					}
					else
					{
						g.drawString("" + (("" + Engine.engine.getGameAttribute("playerDistance")) + ("" + " METERS")), ((320 - getFont(274).font.getTextWidth((("" + Engine.engine.getGameAttribute("playerDistance")) + ("" + " METERS")))/Engine.SCALE) / 2), 120);
					}

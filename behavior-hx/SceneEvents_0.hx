...
class SceneEvents_0 extends SceneScript
{
	...
	public function _customEvent_play():Void
	{
		...
		trace("" + (("" + "highscore ") + ("" + Engine.engine.getGameAttribute("distanceHighScore"))));
	...
	public function _customEvent_gameOverIU():Void
	{
		...
		{
			createRecycledActor(getActorType(17), -10, 20, Script.FRONT);
			getLastCreatedActor().setAnimation("" + "1");
			if((_points > 2))
			{
				runLater(1000 * .7, function(timeTask:TimedTask):Void
				{
					createRecycledActor(getActorType(17), 100, 20, Script.FRONT);
				...
				if((_points > 3))
				{
					...
					{
						createRecycledActor(getActorType(17), 190, 20, Script.FRONT);
	...
	override public function init()
	{
		...
		addWhenDrawingListener(null, function(g:G, x:Float, y:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				g.drawString("" + Engine.engine.getGameAttribute("collected_cans"), 88, 2);
				...
				if(Engine.engine.getGameAttribute("gameOver"))
				{
					...
					{
						g.drawString("" + _tempNumber, 45, 245);
					}
					else
					{
						g.drawString("" + Engine.engine.getGameAttribute("collected_cans"), 37, 245);
					}
					if((_tempNumber < Engine.engine.getGameAttribute("collected_PlasticBottles")))
					{
						g.drawString("" + _tempNumber, 150, 245);
					}
					else
					{
						g.drawString("" + Engine.engine.getGameAttribute("collected_PlasticBottles"), 150, 245);
					}
					if((_tempNumber < Engine.engine.getGameAttribute("collected_glassBottle")))
					{
						g.drawString("" + _tempNumber, 230, 245);
					}
					else
					{
						g.drawString("" + Engine.engine.getGameAttribute("collected_glassBottle"), 230, 245);
					}
					g.setFont(getFont(196));
					if((_tempDistanceNum < Engine.engine.getGameAttribute("playerDistance")))
					{
						g.drawString("" + (("" + _tempDistanceNum) + ("" + " METERS")), 50, 140);
					}
					else
					{
						g.drawString("" + (("" + Engine.engine.getGameAttribute("playerDistance")) + ("" + " METERS")), 50, 140);
					}
					g.setFont(getFont(201));
					g.drawString("" + (("" + "HIGHSCORE ") + ("" + Engine.engine.getGameAttribute("distanceHighScore"))), 90, 195);

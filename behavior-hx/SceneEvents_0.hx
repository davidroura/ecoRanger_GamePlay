...
class SceneEvents_0 extends SceneScript
{
	...
	public function _customEvent_tutorial():Void
	{
		if((!(Engine.engine.getGameAttribute("tutorialDone")) && !(_tutorialStarted)))
		{
			...
			runLater(1000 * 2, function(timeTask:TimedTask):Void
			{
				...
				{
					createRecycledActor(getActorType(81), 140, 280, Script.FRONT);
				}, null);
			}, null);
			runLater(1000 * 8, function(timeTask:TimedTask):Void
			{
				...
				createRecycledActor(getActorType(277), 15, 380, Script.FRONT);
				runLater(1000 * 1, function(timeTask:TimedTask):Void
				{
	...
	override public function init()
	{
		...
		if(Engine.engine.getGameAttribute("game_volumen"))
		{

...
class SceneEvents_0 extends SceneScript
{
	...
	public function _customEvent_tutorial():Void
	{
		if(!(Engine.engine.getGameAttribute("tutorialDone")))
		{
			...
			runLater(1000 * 1.8, function(timeTask:TimedTask):Void
			{
				...
				Engine.engine.setGameAttribute("notificationText", "COLLECT THE TRASH");
			}, null);
			...
			{
				Engine.engine.setGameAttribute("notificationText", "GOOD LUCK OUT THERE");
			}, null);
	...
	override public function init()
	{
		...
		getActor(12).setAnimation("" + Engine.engine.getGameAttribute("selectedBotList")[Std.int(0)]);
		...
		addWhenDrawingListener(null, function(g:G, x:Float, y:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				g.drawString("" + Engine.engine.getGameAttribute("collected_cans"), 95, 2);
				g.drawString("" + Engine.engine.getGameAttribute("collected_PlasticBottles"), 135, 2);
				g.drawString("" + Engine.engine.getGameAttribute("collected_glassBottle"), 195, 2);
				...
				if(Engine.engine.getGameAttribute("gameOver"))
				{
					...
					{
						g.drawString("" + _tempNumber, 45, 220);
					}
					else
					{
						g.drawString("" + Engine.engine.getGameAttribute("collected_cans"), 45, 220);
					}
					if((_tempNumber < Engine.engine.getGameAttribute("collected_PlasticBottles")))
					{
						g.drawString("" + _tempNumber, 150, 220);
					}
					else
					{
						g.drawString("" + Engine.engine.getGameAttribute("collected_PlasticBottles"), 150, 220);
					}
					if((_tempNumber < Engine.engine.getGameAttribute("collected_glassBottle")))
					{
						g.drawString("" + _tempNumber, 230, 220);
					}
					else
					{
						g.drawString("" + Engine.engine.getGameAttribute("collected_glassBottle"), 230, 220);
					}
					g.setFont(getFont(196));
					if((_tempDistanceNum < Engine.engine.getGameAttribute("playerDistance")))
					{
						g.drawString("" + _tempDistanceNum, 120, 150);
					}
					else
					{
						g.drawString("" + Engine.engine.getGameAttribute("playerDistance"), 120, 150);
					}
